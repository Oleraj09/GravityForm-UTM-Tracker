...
**Easy UTM Tracker for Gravity Forms** allows you to easily track your marketing campaigns by capturing UTM parameters from the URL and saving them into your Gravity Forms submissions.
...
1.  Upload the plugin files to the `/wp-content/plugins/gravity-form-utm-tracker` directory, or install the plugin through the WordPress plugins screen directly.
